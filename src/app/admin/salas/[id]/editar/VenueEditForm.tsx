  ...
  return (
    <form onSubmit={handleSubmit} className="mt-10 max-w-2xl space-y-6">
      ...
      <div>
        ...
        <input id="name" name="name" type="text" required defaultValue={venue.name} className={inputClass} />
      </div>
      <div>
        <label htmlFor="city" className={labelClass}>Ciudad *</label>
        <input id="city" name="city" type="text" required defaultValue={venue.city} className={inputClass} />
      </div>
      <div>
        <label htmlFor="address" className={labelClass}>Dirección</label>
        <input id="address" name="address" type="text" defaultValue={venue.address ?? ""} className={inputClass} />
      </div>
      <div>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div>
          ...
          <input id="foundedYear" name="foundedYear" type="number" min={1900} defaultValue={venue.foundedYear ?? ""} className={inputClass} />
        </div>
        <div>
          <label htmlFor="capacity" className={labelClass}>Aforo</label>
          <input id="capacity" name="capacity" type="number" min={1} defaultValue={venue.capacity ?? ""} className={inputClass} />
        </div>
      </div>
      <div>
        <label className="flex cursor-pointer items-center gap-2">
          <input type="checkbox" name="approved" defaultChecked={venue.approved} className="accent-punk-green" />
      ...
      <div>
        ...
        <input id="mapUrl" name="mapUrl" type="url" defaultValue={venue.mapUrl ?? ""} className={inputClass} />
      </div>
      <div className="grid gap-4 sm:grid-cols-2">
        <div>
          <label htmlFor="instagramUrl" className={labelClass}>Instagram</label>
          <input id="instagramUrl" name="instagramUrl" type="url" defaultValue={venue.instagramUrl ?? ""} className={inputClass} placeholder="https://instagram.com/..." />
        </div>
        <div>
          <label htmlFor="facebookUrl" className={labelClass}>Facebook</label>
          <input id="facebookUrl" name="facebookUrl" type="url" defaultValue={venue.facebookUrl ?? ""} className={inputClass} placeholder="https://facebook.com/..." />
        </div>
      </div>
      <div className="flex gap-4">
        ...
        <a href="/admin/salas" className="border-2 border-punk-white/30 px-8 py-3 font-punch text-sm uppercase tracking-widest text-punk-white/70 hover:border-punk-white">
          Cancelar
        </a>
      </div>
    </form>

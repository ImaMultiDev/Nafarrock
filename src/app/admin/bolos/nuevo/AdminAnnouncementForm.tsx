...
export function AdminAnnouncementForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="mt-10 max-w-2xl space-y-6">
      ...
      <div className="border-2 border-punk-green/50 bg-punk-green/5 p-4">
        <p className="font-body text-sm text-punk-white/80">
          El anuncio se publicará directamente como <strong>PUBLICADO POR NAFARROCK</strong>.
        </p>
      </div>
      ...
      <div>
        ...
        <input
          ...
          required
          maxLength={200}
          placeholder="Buscamos bandas para... / Convocatoria..."
      ...
      <div>
        ...
        <textarea
          ...
          required
          minLength={20}
          placeholder="Describe la oportunidad, fechas disponibles, requisitos..."
          className={inputClass}
        />
      </div>
      ...
      <div>
        ...
        <input
          ...
          type="email"
          required
          placeholder="contacto@nafarrock.com"
          className={inputClass}
        />
      </div>
      ...
      <div>
        <label className="flex cursor-pointer items-center gap-2">
          <input type="checkbox" name="enableApplicationForm" className="accent-punk-green" />
